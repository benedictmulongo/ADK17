...
//        System.out.println("oj ojo -> : " + br.readLine());
        ...
        System.out.println("*******************************************************" );
        long s = binary("temp.txt",indexer,"krazer");
        if(s < 0) {
            ...
            System.out.println("*** read 60 but 80 ??***" + read_60(70,br,"krazer"));
        }
/*        br.seek(s);
        String [] raden = splitter(br.readLine());
        int antal_ord = raden.length-1;
        String korpus = "/var/temp/korpus.txt";
        long red;
        ...
        System.out.println("*******************************************************" );
//        System.out.println("*** read 60 but 80 ??***" + read_60(70,br,));
    }
    ...
    //pos -> red github version
    // string key  the key searched
    // randomaccessfile()
